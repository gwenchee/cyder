#ifndef CYDER_SRC_PACKAGED_MATERIAL_H_
#define CYDER_SRC_PACKAGED_MATERIAL_H_
...
///   @endcode
///
class PackagedMaterial: public Material {
 ...
 public:
  ...
  /// creator's context.
  static Ptr Create(Agent* creator, double quantity, Package::Ptr c);

  /// Creates a new material resource that does not actually exist as part of
  /// the simulation and is untracked.
  static Ptr CreateUntracked(double quantity, Package::Ptr c);
...
/// purposes.
PackagedMaterial::Ptr NewBlankMaterial(double qty);
